    ...
    <>
        <View style={styles.container}>
            ...
            <View style={styles.itemsContainer}>
                ...
                {items.map(item=>(
                   <TouchableOpacity key={String(item.id)}style={[styles.item,selectedItems.includes(item.id)?styles.selectedItem:{}]} onPress={()=>handleSelectItems(item.id)} activeOpacity={0.6}>
